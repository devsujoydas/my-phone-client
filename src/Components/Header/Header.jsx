...
const Header = () => {
    ...
    return (
        <nav className='sticky top-0 left-0 z-20 shadow-2xl bg-gray-600 text-white w-full '>
            <div className='container px-6 py-4 mx-auto'>
                <div className='lg:flex lg:items-center lg:justify-between  '>
                    <div className='flex items-center  justify-between  '>
                        <Link to="/" className=''>
                            <h1 className='text-3xl font-semibold'>Phone Hunt Express</h1>
                        </Link>
                            ...
                            <div>
                                <button onClick={() => { setShowProfile(!showProfile) }} className='flex justify-center items-center gap-2 cursor-pointer'>
                                    <div className='overflow-hidden active:scale-95 rounded-full'>
                                        <img alt="Profile Img" src={"https://img.freepik.com/premium-vector/man-avatar-profile-picture-vector-illustration_268834-538.jpg"} className=" h-12 w-12 scale-105 transition-all " />
                                    </div>
